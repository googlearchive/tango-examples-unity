...
public class RelocalizingOverlay : MonoBehaviour, ITangoPose, ITangoLifecycle
{
    ...
    /// <summary>
    /// Unity OnEnable override function.
    /// </summary>
    ...
    /// Unity OnDisable override function.
    /// </summary>
    /// <param name="isActive">If true, set the relocalization overlay to enabled, otherwise, disabled.</param>
    public void SetOverlayActive(bool isActive)
    {
        m_relocalizationOverlay.SetActive(isActive);
    }
