//-----------------------------------------------------------------------
// <copyright file="MarshallingHelper.cs" company="Google">
//
...
namespace Tango
{
    ...
    /// </summary>
    internal static class MarshallingHelper
    {
        /// <summary>
        ...
        public static void MarshalUnmanagedStructArrayToList<T>(IntPtr arrayPtr, int arrayLength, List<T> list) where T : struct
        {
